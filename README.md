...
- Choose one visible tile, then place the complete square into one empty large slot.
...
- Tiles never rotate, flip, overlap, or occupy individual mini-cell positions.
